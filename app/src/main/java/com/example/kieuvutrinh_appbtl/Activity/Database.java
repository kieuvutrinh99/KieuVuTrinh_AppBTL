...
import com.example.kieuvutrinh_appbtl.Activity.model.Question;
...
public class Database extends SQLiteOpenHelper {
    ...
    //Các giá trị của insert
    private void CreatCategories(){
        //văn hóa id1
        Category c1 = new Category("VĂN HÓA ");
        insertCategories(c1);
        //lịch sử id2
        Category c2 = new Category("LỊCH SỬ");
        insertCategories(c2);
        //dịch bệnh id3
        Category c3 = new Category("DỊCH BỆNH");
        insertCategories(c3);
    }
    ...
    //Tạo bảng câu hỏi
    private void CreatQuestions(){
        //Dữ liệu bảng question
        //câu hỏi + 4 đáp án+vị trí đ/a đúng + id chủ đề
        ...
        insertQuestion(q13);
        // 13 bản ghi cho question
    }
    // hàm trả dữ liệu các chủ đề
    ...
    public ArrayList<Question> getQuestion(int catogoryID){
        ...
        String[] selectionArgs = new String[]{String.valueOf(catogoryID)};
